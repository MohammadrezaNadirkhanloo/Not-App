      ...
      <div>
        ...
        <div>
          <div>
            ...
            <div className="mx-3 border border-2 rounded-4 border_color py-3 px-5 ">
              <div className="d-flex justify-content-between">
                <div className="d-flex flex-column">
                  <p className="fw-bold fs-4 text_color">title</p>
                  <p className="fw-semibold fs-6 text_color Description">Description </p>
                </div>
              ...
              <div>
                <p className="text_color fw-bold">2024/9/5</p>
              </div>
            </div>
          </div>
        </div>
